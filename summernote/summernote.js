    ...
    var tplDialogInfo = {
      image: function (lang, options) {
        ...
        var body = '<div class="form-group row note-group-select-from-files">' +
                   ...
                   '<div class="form-group row">' +
                     ...
                     '<input class="note-image-url form-control col-sm-12" type="text" />' +
                   '</div>';
      ...
      link: function (lang, options) {
        var body = '<div class="form-group row">' +
                     ...
                     '<input class="note-link-text form-control col-sm-12" type="text" />' +
                   '</div>' +
                   '<div class="form-group row">' +
                     '<label>' + lang.link.url + '</label>' +
                     '<input class="note-link-url form-control col-sm-12" type="text" value="http://" />' +
                   '</div>' +
