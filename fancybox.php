...
class fancybox{
  ...
  //建構函數
  function fancybox($name="",$width='90%',$height=NULL,$show_jquery=true,$show_js=true){
    //$this->name=randStr();
    $this->name=$name;
    $this->width=$width;
  ...
  //產生表單語法
  function renderForm($url="",$reload=true,$prevent_closed_outside=false,$autoPlay=false,$playSpeed=0){
    $jquery=$this->show_jquery?get_jquery():"";
