<div id="xoops_theme_content_zone" class="row">
    <{if $xoBlocks.canvas_left}>
        <div class="col-lg-12" id="xoops_theme_left_zone" style="background-color:<{$lb_color}>;">
    ...
    <div class="col-lg-12" id="xoops_theme_center_zone" style="background-color:<{$cb_color}>;">
    ...
    <{if $xoBlocks.canvas_right}>
        <div class="col-lg-12" id="xoops_theme_right_zone" style="background-color:<{$rb_color}>;">
