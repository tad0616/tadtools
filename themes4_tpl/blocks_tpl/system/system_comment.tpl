    ...
    <div class="row">
        <div class="col-sm-2 col-lg-2 xoops-comment-author aligncenter">
            <{if $comment.poster.id != 0}>
                <img src="<{$xoops_upload_url|default:''}>/<{$comment.poster.avatar}>" class="img-fluid rounded image-avatar" alt="">
    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12 alignright">
            <{if $xoops_iscommentadmin == true}>
                <a href="<{$editcomment_link|default:''}>&amp;com_id=<{$comment.id}>" title="<{$lang_edit|default:''}>" class="btn btn-light btn-sm">
                    <span class="glyphicon glyphicon-edit"></span>
                </a>
                <a href="<{$replycomment_link|default:''}>&amp;com_id=<{$comment.id}>" title="<{$lang_reply|default:''}>" class="btn btn-light btn-sm">
                    <span class="glyphicon glyphicon-comment"></span>
                </a>
                <a href="<{$deletecomment_link|default:''}>&amp;com_id=<{$comment.id}>" title="<{$lang_delete|default:''}>" class="btn btn-light btn-sm">
            ...
            <{elseif $xoops_isuser == true || $anon_canpost == true}>
                <a href="<{$replycomment_link|default:''}>&amp;com_id=<{$comment.id}>" class="btn btn-light btn-sm">
                    <span class="glyphicon glyphicon-comment"></span>
                </a>
            <{else}>
                &nbsp;        <!-- ? -->
