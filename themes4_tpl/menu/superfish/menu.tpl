<link rel="stylesheet" type="text/css" href="<{xoAppUrl modules/tadtools/themes4_tpl/menu/superfish/css/superfish.css}>" />
<{if $vertical}>
<link rel="stylesheet" type="text/css" href="<{xoAppUrl modules/tadtools/themes4_tpl/menu/superfish/css/superfish-vertical.css}>" />
<{/if}>
...
<script type="text/javascript" src="<{xoAppUrl modules/tadtools/themes4_tpl/menu/superfish/js/hoverIntent.js}>"></script>
<script type="text/javascript" src="<{xoAppUrl modules/tadtools/themes4_tpl/menu/superfish/js/superfish.js}>"></script>
