<script src="<{xoAppUrl modules/tadtools/themes4_tpl/slider/sliderengine/amazingslider.js}>"></script>
<script src="<{xoAppUrl modules/tadtools/themes4_tpl/slider/sliderengine/initslider-3.js}>"></script>
