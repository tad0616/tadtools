...
<{if $xoBlocks.footer_left || $xoBlocks.footer_right || $xoBlocks.footer_center}>
    <div class="row">
        <{if $xoBlocks.footer_left}>
            <div class="col-lg footerLeftBlock" id="footerLeftBlock">
        ...
        <{if $xoBlocks.footer_center}>
            <div class="col-lg footerCenterBlock" id="footerCenterBlock">
        ...
        <{if $xoBlocks.footer_right}>
            <div class="col-lg footerRightBlock" id="footerRightBlock">
