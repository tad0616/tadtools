...
class PHPExcel_Style_Color extends PHPExcel_Style_Supervisor implements PHPExcel_IComparable
{
    ...
    {
        return self::_getColourComponent($RGB, mb_strlen($RGB) - 6, $hex);
    }
    ...
    {
        return self::_getColourComponent($RGB, mb_strlen($RGB) - 4, $hex);
    }
    ...
    {
        return self::_getColourComponent($RGB, mb_strlen($RGB) - 2, $hex);
    }
