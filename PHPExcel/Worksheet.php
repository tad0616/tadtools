...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
    ...
    public function cellExists($pCoordinate = 'A1')
    {
        ...
        if (false !== mb_strpos($pCoordinate, '!')) {
            ...
            return $this->_parent->getSheetByName($worksheetReference[0])->cellExists(mb_strtoupper($worksheetReference[1]));
        }
    ...
    {
        if (isset($this->_conditionalStylesCollection[mb_strtoupper($pCoordinate)])) {
            return true;
        }
    ...
    {
        unset($this->_conditionalStylesCollection[mb_strtoupper($pCoordinate)]);
    ...
    {
        $this->_conditionalStylesCollection[mb_strtoupper($pCoordinate)] = $pValue;
...
//
    ...
    public static function extractSheetTitle($pRange, $returnRange = false)
    {
        ...
        if ($returnRange) {
            return [ trim(mb_substr($pRange, 0, $sep), "'"),
                          mb_substr($pRange, $sep + 1),
                        ];
        }
