...
class PHPExcel_Writer_Excel5_Xf
{
    ...
    public function writeXf()
    {
        ...
        $atr_num = (0 != $this->_numberFormatIndex) ? 1 : 0;
        $atr_fnt = (0 != $this->_fontIndex) ? 1 : 0;
        ...
        if (0 == self::_mapBorderStyle($this->_style->getBorders()->getBottom()->getBorderStyle())) {
            $this->_bottom_color = 0;
        }
        if (0 == self::_mapBorderStyle($this->_style->getBorders()->getTop()->getBorderStyle())) {
            $this->_top_color = 0;
        }
        if (0 == self::_mapBorderStyle($this->_style->getBorders()->getRight()->getBorderStyle())) {
            $this->_right_color = 0;
        }
        if (0 == self::_mapBorderStyle($this->_style->getBorders()->getLeft()->getBorderStyle())) {
            $this->_left_color = 0;
        }
        if (0 == self::_mapBorderStyle($this->_style->getBorders()->getDiagonal()->getBorderStyle())) {
            $this->_diag_color = 0;
        }
