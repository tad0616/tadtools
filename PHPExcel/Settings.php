...
class PHPExcel_Settings
{
    ...
    {
        if (!in_array($libraryName, self::$_chartRenderers, true)) {
            return false;
        }
    ...
    {
        if (!in_array($libraryName, self::$_pdfRenderers, true)) {
            return false;
        }
    ...
    {
        if (null === self::$_libXmlLoaderOptions && defined(LIBXML_DTDLOAD)) {
