...
<form name="notificationlist" action="notifications.php" method="post">
    ...
    <input class="btn btn-light" type="submit" name="delete_cancel" value="<{$lang_cancel|default:''}>"/>
    <input class="btn btn-light" type="reset" name="delete_reset" value="<{$lang_clear|default:''}>"/>
    <input class="btn btn-light" type="submit" name="delete" value="<{$lang_delete|default:''}>"/>
