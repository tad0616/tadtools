      ...
      <div class="form-group row mb-3">
        <div class="col-sm-12">
          <div class="input-group">
              ...
              <input type="text" name="uname" id="uname" class="form-control" maxlength="25" value="" aria-required="true" aria-describedby="loginMsg" aria-invalid="false" placeholder="帳號必填">
          </div>
        </div>
      </div>
      ...
      <div class="form-group row mb-3">
        <div class="col-sm-12">
          <div class="input-group">
            ...
            <input type="password" name="pass" id="pass" class="form-control" maxlength="32" aria-required="true" aria-describedby="loginMsg" aria-invalid="false" placeholder="密碼必填">
          </div>
        </div>
      </div>
