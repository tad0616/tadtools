 ...
 */
    ...
    $translation['ratio_too_high']              = 'De afbeeldings ratio is te groot (de afbeelding is te breed).';
    $translation['ratio_too_low']               = 'De afbeeldings ratio te laag (de afbeelding is te hoog).';
