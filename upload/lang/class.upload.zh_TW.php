...
$translation['destination_dir_write']       = '%s 目標目錄無法寫入（請將 uploads 底下目錄均設為777），無法繼續進行處理。';
$translation['destination_path_write']      = '%s 目錄路徑無法寫入（請將 uploads 底下目錄均設為777），無法繼續進行處理。';
