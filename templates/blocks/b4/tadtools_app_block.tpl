<div class="row">
    <div <{if $block.direction=='h'}>class="col-sm-6"<{/if}>>
        <a href="<{$block.url1}>" target="_blank"><img src="<{$xoops_url}>/modules/tadtools/images/app_qrcode.png" alt="<{$smarty.const._MB_TT_APP_DOWNLOAD}>" class="img-fluid" style="width:<{$block.width}>px;float:left;margin:0px 6px 6px 0px;"></a>
