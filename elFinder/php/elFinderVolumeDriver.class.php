...
abstract class elFinderVolumeDriver {
	...
	public function mount(array $opts) {
		...
		//die($this->uploadMaxSize.'-'.$this->options['uploadMaxSize']);
...
//return $this->setError(filesize($tmpname).'---'.$this->uploadMaxSize.'-'.$this->options['uploadMaxSize']);
