...
class PHPWord_Style_TableFull
{
    ...
    public function __construct($styleTable = null, $styleFirstRow = null, $styleLastRow = null)
    {
        ...
        if (null !== $styleTable && is_array($styleTable)) {
    ...
    public function setStyleValue($key, $value)
    {
        ...
        } elseif ('_borderColor' == $key) {
            $this->setBorderColor($value);
        } elseif ('_cellMargin' == $key) {
    ...
    {
        return [$this->_cellMarginTop, $this->_cellMarginLeft, $this->_cellMarginRight, $this->_cellMarginBottom];
    }
}
