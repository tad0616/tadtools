...
class PHPWord_Section_Table_Cell
{
    ...
    public function addImage($src, $style = null)
    {
        ...
        if (null !== $image->getSource()) {
            ...
            } elseif ('header' == $this->_insideOf) {
                $rID = PHPWord_Media::addHeaderMediaElement($this->_pCount, $src);
            } elseif ('footer' == $this->_insideOf) {
    ...
    {
        if ('footer' == $this->_insideOf || 'header' == $this->_insideOf) {
            //$text = utf8_encode($text);
