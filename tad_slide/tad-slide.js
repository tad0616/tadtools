  ...
  class TadSlide {
    ...
    _init() {
      ...
      if (opts.pauseOnHover) {
        el.addEventListener('mouseenter', () => this._hoverPause(true));
        el.addEventListener('mouseleave', () => this._hoverPause(false));
      }
