<{foreach from=$menu_var item=m}>
    <li>
        ...
        <{if $m.img|default:false}><img src="<{$m.img}>" alt="<{$m.title}> icon"><{elseif $m.icon}><i class="fa <{$m.icon}>"></i><{/if}> <{$m.title}> <{if $m.submenu|default:false}> <span class="caret"></span><{/if}>
        </a>
