      ...
      <{else}>
        <ul class="dropdown-menu">
          <{foreach from=$m.submenu item=m2}>
            ...
            <{else}>
              <li>
                <a <{if $m2.submenu}>tabindex="-1"<{/if}> <{if $m2.url!=''}>href="<{if $m2.target=="popup"}>javascript:tad_themes_popup('<{$m2.url}>');<{else}><{$m2.url}><{/if}>" <{if $m2.target!="popup"}>target="<{$m2.target}>"<{/if}><{/if}>>
                ...
                <{if $m2.submenu}>
                  <ul class="dropdown-menu">
                    <{foreach from=$m2.submenu item=m3}>
                      <li>
                        <a <{if $m3.submenu}>tabindex="-1"<{/if}> <{if $m3.url!=''}>href="<{if $m3.target=="popup"}>javascript:tad_themes_popup('<{$m3.url}>');<{else}><{$m3.url}><{/if}>" <{if $m3.target!="popup"}>target="<{$m3.target}>"<{/if}><{/if}>>
