<ul class="dropdown-menu">
  <{if $xoops_isadmin}>
    ...
    <li>
      <a rel="tooltip" href="<{$xoops_url}>/modules/system/admin.php?fct=preferences&op=show&confcat_id=1" title="<{$smarty.const.TF_SYSTEM_CONFIG}>">
    ...
    <li>
      <a rel="tooltip" href="<{$xoops_url}>/modules/tad_adm/admin/main.php" title="<{$smarty.const.TF_SYSTEM_MODADM}>">
    ...
    <li>
      <a rel="tooltip" href="<{$xoops_url}>/modules/tad_adm/pma.php" title="<{$smarty.const.TF_SYSTEM_DBADM}>" target="_blank">
