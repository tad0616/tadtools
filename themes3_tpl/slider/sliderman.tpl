<script src="<{xoAppUrl modules/tadtools/themes3_tpl/slider/sliderman/js/sliderman.1.3.8.js}>"></script>
<link rel="stylesheet" type="text/css" href="<{xoAppUrl modules/tadtools/themes3_tpl/slider/sliderman/css/sliderman.css}>" />
