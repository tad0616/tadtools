<div id="xoops_theme_content_zone" <{if $theme_kind!="html"}>class="row"<{/if}>>
  ...
  <{if $xoBlocks.canvas_left}>
    ...
    <div id="xoops_theme_left_zone" <{if $theme_kind!="html"}>class="row"<{/if}> style="background-color:<{$lb_color}>;">
      ...
      <div class="<{if $theme_kind!="html"}>col-sm-<{/if}><{$lb_width}>">
  ...
  <div id="xoops_theme_center_zone" <{if $theme_kind!="html"}>class="row"<{/if}> style="background-color:<{$cb_color}>;">
