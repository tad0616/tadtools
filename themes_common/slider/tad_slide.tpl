<{if $slider_var|default:false}>
    <link rel="stylesheet" type="text/css" href="<{$xoops_url}>/modules/tadtools/tad_slide/tad-slide.css?t=20260320" >
    <script type="text/javascript" src="<{$xoops_url}>/modules/tadtools/tad_slide/tad-slide.js?t=20260320"></script>
